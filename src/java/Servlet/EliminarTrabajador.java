...
public class EliminarTrabajador extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(ct.eliminarTrabajador(idTrabajador)){
            response.getWriter().println("Trabajador Eliminado Exitosamente");
        }else{
            response.getWriter().println("Error al eliminar al Trabajador");
        }
    }
