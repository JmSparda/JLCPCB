...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 27-05-2016 a las 06:22:43
...
SELECT modu_prof.id_moduprof, admprof.prof_nombre, admmodu.modu_nombre 
FROM modu_prof
...
(4, 'MOD003', 'ROLES', 'Administrar ROLES', '2016-05-25 11:37:42', 'D');
...
(1, 'JUAN MANUEL', 'CABANILLAS', 'LOPEZ', 'MASCULINO', '1991-07-21', 1, 71484498, 'MZ I LOTE 28 - LA ARBOLEDA', '957803984', 'jmlopez2332@gmail.com', 'img/trabajadores/JUAN MANUEL CABANILLAS LOPEZ.jpg'),
(2, 'PETER BENJAMIN', 'PARKER', 'REILLY', 'Masculino', '1991-07-21', 1, 21312323, 'QUEENS', '12345656', 'peterparker@gmail.com', 'img/trabajadores/PETER BENJAMIN PARKER.jpg');
...
--
ALTER TABLE `admmodu`
  MODIFY `modu_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
...
--
ALTER TABLE `modu_prof`
  MODIFY `id_moduprof` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
