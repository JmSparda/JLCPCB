...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 30-05-2016 a las 07:54:25
...
--
ALTER TABLE `blienlaces`
  MODIFY `bli_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT de la tabla `modu_prof`
--
ALTER TABLE `modu_prof`
  MODIFY `id_moduprof` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
