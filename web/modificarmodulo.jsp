<%-- 
    ...
    Created on : 23/05/2016, 01:58:17 PM
    Author     : FAST
--%>
...
<!DOCTYPE html>
<%
    ControladorModulo cp = new ControladorModulo(); 
    int idModulo = Integer.parseInt(request.getParameter("id"));
%>
<html>
    <head>
        <meta charset="utf-8">
