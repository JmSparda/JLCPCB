                    ...
                    <div class="content-wrapper">
                        <div class="content-inner content-inner-white">
                            <div class="page-header page-header-dark-blue">
                                ...
                                <h1><i class="icon-bar-chart"></i>Registro de Módulos</h1>
                            </div>
                                <div class="main-content">
                                    <div class="widget">
                                        <h3 class="section-title first-title"><i class="icon-table"></i>Tabla Módulos</h3>
                                        <div class="text-right row">
                                            <div class="col-md-1">
                                                <button type="button" class="btn btn-primary btn-round" data-toggle="modal" data-target="#myModalRegistro" data-backdrop="static" data-keyboard="false">Nuevo Módulo</button>
                                            </div>
    ...
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-content ">
            <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel">Registro de Módulos</h4>
            </div>
